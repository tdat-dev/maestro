...
import { configureWorkspace, initWorkspace, createWorkspace, activateWorkspace, bootDetached, confirmModal, wirePaneSearch } from "./workspace";
...
configureWorkspace({ createAgent, removeAgent, updateCount, showWorkspace, showView, syncResumeAll, setFileTreeRoot: (dir) => fileTree?.setRoot(dir) });
